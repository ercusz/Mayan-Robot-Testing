...
${TRANSITION}    xpath://li[4]/a[@href="/workflows/workflow_templates/97/transitions/"]
${STATE}    http://localhost/#/workflows/workflow_templates/97/states/
${LOCATION_TRANSITION}    http://localhost/#/workflows/workflow_templates/97/transitions/
${CREATE_NEXT_TRANSITION}    xpath://li[13]/a[@href="/workflows/workflow_templates/97/transitions/create/"]
